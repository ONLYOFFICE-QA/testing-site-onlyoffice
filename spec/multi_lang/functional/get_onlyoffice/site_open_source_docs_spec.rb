...
describe 'Open source bundlers download' do
  ...
  TestingSiteOnlyffice::SiteDownloadData.open_source_docs_list.each do |installer|
    describe installer.to_s do
      ...
      it "[Site][DownloadOpenSource][Docs] Check `#{installer}`'Read instructions' link /download.aspx" do
        ...
        instruction_title = TestingSiteOnlyffice::SiteDownloadData.open_source_docs_info[installer.to_s]['instruction']
  ...
  TestingSiteOnlyffice::SiteDownloadData.open_source_docs_list_type[:with_github].each do |installer|
    it "[Site][DownloadOpenSource][Docs] Check `#{installer}`'Github' link /download.aspx" do
      ...
      github_title = TestingSiteOnlyffice::SiteDownloadData.open_source_docs_info[installer.to_s]['github']
  ...
  TestingSiteOnlyffice::SiteDownloadData.open_source_docs_list_type[:without_github].each do |installer|
