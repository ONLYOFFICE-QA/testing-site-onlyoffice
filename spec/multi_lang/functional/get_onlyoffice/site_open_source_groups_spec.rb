...
describe 'Open source groups download' do
  ...
  TestingSiteOnlyffice::SiteDownloadData.open_source_groups_list.each do |installer|
    ...
    it "[Site][DownloadOpenSource][Groups] Check `#{installer}`'Read instructions' link /download.aspx" do
      ...
      instruction_title = TestingSiteOnlyffice::SiteDownloadData.open_source_groups_info[installer.to_s]['instruction']
    ...
    it "[Site][DownloadOpenSource][Groups] Check `#{installer}`'Github' link /download.aspx" do
      ...
      github_title = TestingSiteOnlyffice::SiteDownloadData.open_source_groups_info[installer.to_s]['github']
