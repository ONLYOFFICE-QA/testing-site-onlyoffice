...
describe 'Request free cloud' do
  before do
    ...
    non_profit_organizatins_page = site_home_page.click_nonprofits
  ...
  it '[Site][Nonprofits] Send free cloud request for nonprofit' do
    ...
    site_admin_email = OnlyofficeIredmailHelper::IredMailHelper.new(username: TestingSiteOnlyoffice::SiteData::PARTNERS_EMAIL)
