shared_examples_for 'connector_download' do |connectors_list|
  connectors_list.each do |connector|
    describe connector.to_s do
      ...
      # it "[Site][OpenSource][Connectors][#{connector}] 'Get on Github' button works /download.aspx#connectors" do
      ...
      # end
      #
      # it "[Site][OpenSource][Connectors][#{connector}] 'Read installation' button works /download.aspx#connectors" do
      ...
      it "[Site][OpenSource][Connectors][#{connector}]release info on site matches github data /download.aspx#connectors" do
